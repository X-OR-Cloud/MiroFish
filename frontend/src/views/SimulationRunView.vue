...
// Get maxRounds directly from query params during initialization to ensure child components get it immediately
...
const handleNextStep = () => {
  // Step3Simulation component will directly handle report generation and routing
...
onMounted(() => {
  ...
  // Record maxRounds configuration (value already retrieved from query params during initialization)
  if (maxRounds.value) {
