...
# Tắt cảnh báo resource_tracker của multiprocessing (từ các thư viện bên thứ ba như transformers)
# Cần được đặt trước tất cả các import khác
...
def create_app(config_class=Config):
    ...
    # Configure JSON encoding: ensure Vietnamese/Chinese characters display directly (not \uXXXX format)
