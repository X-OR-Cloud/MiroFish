...
Using project context mechanism with server-side state persistence
"""
...
def generate_ontology():
    ...
    Parameters:
        ...
        additional_context: Additional information (optional)
...
def build_graph():
    ...
    try:
        ...
        if project.status == ProjectStatus.GRAPH_BUILDING and not force:
            return jsonify({
                "success": False,
                "error": "Graph is being built, do not resubmit. If you need to force rebuild, add force: true",
        ...
        return jsonify({
            ...
            "data": {
                "project_id": project_id,
                "task_id": task_id,
                "message": "Graph building task started, please query progress through /task/{task_id}"
            }
        })
