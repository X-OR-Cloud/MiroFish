...
Used to persist project state on the server side, avoiding large data transfer between frontend interfaces
"""
...
class ProjectManager:
    ...
    def get_project(cls, project_id: str) -> Optional[Project]:
        ...
        Returns:
            Project object, return None if does not exist
        """
    ...
    def list_projects(cls, limit: int = 50) -> List[Project]:
        ...
        Returns:
            Project list, sorted by creation time in reverse order
        """
        cls._ensure_projects_dir()
