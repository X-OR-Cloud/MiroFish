"""
textLogRecordtext
textRecordOASISSimulationtextAgenttext，textMonitortext
...
class PlatformActionLogger:
    ...
    def __init__(self, platform: str, base_dir: str):
        ...
        Args:
            ...
            base_dir: SimulationDirectorytextPath
        """
...
class ActionLogger:
    """
    textLogRecordtext（textInterface）
    text SimulationLogManager text
    """
